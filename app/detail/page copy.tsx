        ...
        <div className="w-full items-center">
          ...
          <div className="container flex-1 relative mx-auto flex">
              ...
              <div className="mt-4 p-4 bg-[#1C1C28] rounded-lg shadow-md">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {card.availability.map((availability, index) => (
                    <Badge
                      key={index}
                      className="bg-gray-700 hover:bg-gray-700 text-white text-sm font-normal rounded-md"
                    >
                      {availability}
                    </Badge>
                  ))}
            ...
            <div className="flex-1 flex flex-col p-4">
              ...
              {/* Description */}
              <div className="text-white mt-2 mb-4">{card.desc}</div>
              {/* Genre */}
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {card.genre.map((genre, index) => (
                  <Badge
                    key={index}
                    className="bg-[#21212E] hover:bg-[#343448] text-white text-md font-normal rounded-md"
                  >
                    {genre}
                  </Badge>
                ))}
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {card.actor.map((actor, index) => (
                  <Badge
                    key={index}
                    className="bg-[#21212E] hover:bg-[#343448] text-white font-normal rounded-md"
                  >
                    {actor}
                  </Badge>
                ))}
              ...
              <div className="mt-4 p-4 bg-[#1C1C28] rounded-lg shadow-md">
                <div className="flex items-center justify-between">
                  <h3 className="flex items-center space-x-4 text-white text-md font-normal">
                    Reviews
                  </h3>
