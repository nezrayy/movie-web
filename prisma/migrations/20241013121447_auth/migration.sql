/*
  ...
  - Added the required column `awardYear` to the `Award` table without a default value. This is not possible if the table is not empty.
...
*/
-- AlterTable
ALTER TABLE `award` ADD COLUMN `awardYear` INTEGER NOT NULL,
...
CREATE TABLE `PreUser` (
    ...
    UNIQUE INDEX `PreUser_emailToken_key`(`emailToken`),
    PRIMARY KEY (`id`)
