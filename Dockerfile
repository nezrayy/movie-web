...
# Salin file package.json dan package-lock.json dari folder `fe` ke container
...
# Salin seluruh kode aplikasi ke dalam container (folder `fe` termasuk subfolder `pages` atau `app`)
COPY ./fe . 
